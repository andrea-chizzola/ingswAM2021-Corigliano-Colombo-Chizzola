...
public class GamesHandler {
    ...
    /**
     * contains the nicknames of disconnected players and the related game id (nickname - id)
     */
     ...
     * @return returns true if the selected player is currently in an active match
     */
    public synchronized boolean isPlaying(String nickname){
     ...
     */
    public void addWaitingGame(Game gameHandler){
     ...
     */
    public void addActiveGame(Game gameHandler){
    ...
    public boolean isNicknameAvailable(String nickname){
        ...
        for(Game game : waitingConnection){
            if(game.containsPlayer(nickname)) return false;
        }
     ...
     */
    public synchronized void manageDisconnection(String nickname){
    ...
    public synchronized void manageReconnection(String nickname, ClientConnection connection){
        ...
        if(inactivePlayers.containsKey(nickname)){
            ...
            getGameById(inactivePlayers.get(nickname)).addPlayer(nickname, connection);
